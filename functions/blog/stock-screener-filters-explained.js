...
export async function onRequestGet() {
  ...
  <main style="max-width:760px;margin:0 auto;padding:40px 16px 72px;font-family:Inter,system-ui,sans-serif;color:#f3f4f6">
    ...
    <p style="line-height:1.8;color:#d1d5db;font-size:16px;margin:0 0 16px">D/E = Total Debt ÷ Shareholders' Equity. A D/E below 0.5 indicates a conservatively financed business. High D/E amplifies risk — especially in rising rate environments. The <a href="/screens/low-debt-stocks" style="color:#2dd4bf;font-weight:600">Low Debt Stocks screen</a> sets D/E ≤ 0.5.</p>
