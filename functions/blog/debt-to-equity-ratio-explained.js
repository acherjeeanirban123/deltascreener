...
export async function onRequestGet() {
  ...
  const bodyHtml = `
    ...
    <main style="max-width:760px;margin:0 auto;padding:40px 16px 72px;font-family:Inter,system-ui,sans-serif;color:#f3f4f6">
      ...
      <div style="background:#f3f4f6;border-radius:12px;padding:16px 20px;font-family:monospace;font-size:15px;color:#e5e7eb;margin:0 0 20px">D/E Ratio = Total Liabilities ÷ Shareholders' Equity</div>
