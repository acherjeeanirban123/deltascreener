...
export async function onRequestGet() {
  ...
  <main style="max-width:760px;margin:0 auto;padding:40px 16px 72px;font-family:Inter,system-ui,sans-serif">
    <nav aria-label="Breadcrumb" style="margin-bottom:20px"><ol style="list-style:none;padding:0;margin:0;display:flex;gap:6px;font-size:13px;font-weight:700;letter-spacing:.08em;text-transform:uppercase;color:#5c6774"><li><a href="/" style="color:#0f766e;text-decoration:none">Home</a></li><li style="color:#9ca3af">/</li><li><a href="/blog" style="color:#0f766e;text-decoration:none">Blog</a></li><li style="color:#9ca3af">/</li><li style="color:#374151">Dividend Screener</li></ol></nav>
    ...
    <p style="line-height:1.8;color:#374151;font-size:16px;margin:0 0 16px">Open the <a href="/screener" style="color:#0f766e;font-weight:600">free screener</a> and set these filters: Dividend Yield &gt;= 2, Debt/Equity &lt;= 1, ROE &gt;= 10. Sort by Dividend Yield descending to find the highest-yielding qualifying stocks at the top.</p>
    <p style="line-height:1.8;color:#374151;font-size:16px;margin:0 0 20px">You can also use the pre-built <a href="/screens/dividend-stocks" style="color:#0f766e;font-weight:600">Dividend Stocks screen</a> and <a href="/screens/low-debt-dividend-stocks" style="color:#0f766e;font-weight:600">Low Debt Dividend Stocks screen</a> for instant results.</p>
    ...
    <div style="margin-top:40px;padding:24px;border-radius:16px;background:#eef8f5;border:1px solid rgba(15,118,110,.15)">
      <strong style="display:block;font-size:16px;color:#0f766e;margin-bottom:8px">Find Dividend Stocks Free →</strong>
