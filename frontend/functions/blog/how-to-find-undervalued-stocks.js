...
export async function onRequestGet() {
  ...
  <main style="max-width:760px;margin:0 auto;padding:40px 16px 72px;font-family:Inter,system-ui,sans-serif">
    <nav aria-label="Breadcrumb" style="margin-bottom:20px"><ol style="list-style:none;padding:0;margin:0;display:flex;gap:6px;font-size:13px;font-weight:700;letter-spacing:.08em;text-transform:uppercase;color:#5c6774"><li><a href="/" style="color:#0f766e;text-decoration:none">Home</a></li><li style="color:#9ca3af">/</li><li><a href="/blog" style="color:#0f766e;text-decoration:none">Blog</a></li><li style="color:#9ca3af">/</li><li style="color:#374151">Undervalued Stocks</li></ol></nav>
    <div style="font-size:12px;font-weight:800;letter-spacing:.12em;text-transform:uppercase;color:#0f766e;margin-bottom:10px">Value Investing</div>
    ...
    <p style="line-height:1.8;color:#374151;font-size:16px;margin:0 0 16px">The price-to-earnings ratio (P/E) is the most widely used valuation metric. A low P/E can indicate an undervalued stock — but only when earnings are real and recurring. Use the <a href="/screener" style="color:#0f766e;font-weight:600">DeltaScreener</a> to filter for P/E &lt; 15 on NYSE and NASDAQ stocks. Pair this with a minimum EPS to exclude loss-making companies.</p>
    ...
    <p style="line-height:1.8;color:#374151;font-size:16px;margin:0 0 16px">Cheap stocks aren't always good stocks. Combine low valuation with a minimum ROE of 10–15% to ensure the business actually generates returns for shareholders. The <a href="/screens/undervalued-tech-stocks" style="color:#0f766e;font-weight:600">undervalued tech stocks screen</a> on DeltaScreener uses this exact combination.</p>
    ...
    <div style="display:grid;gap:12px;margin:0 0 32px">
      <a href="/screens/undervalued-tech-stocks" style="padding:16px 20px;border-radius:12px;border:1px solid #e5e7eb;background:#f9fafb;text-decoration:none;display:block"><strong style="color:#0f766e">Undervalued Tech Stocks</strong><span style="color:#6b7280;font-size:14px;display:block;margin-top:4px">Low P/E + High ROE technology stocks on US exchanges</span></a>
      <a href="/screens/low-pe-stocks" style="padding:16px 20px;border-radius:12px;border:1px solid #e5e7eb;background:#f9fafb;text-decoration:none;display:block"><strong style="color:#0f766e">Low P/E Stocks</strong><span style="color:#6b7280;font-size:14px;display:block;margin-top:4px">Broad value screen across all US sectors</span></a>
      <a href="/screens/low-pb-stocks" style="padding:16px 20px;border-radius:12px;border:1px solid #e5e7eb;background:#f9fafb;text-decoration:none;display:block"><strong style="color:#0f766e">Low P/B Stocks</strong><span style="color:#6b7280;font-size:14px;display:block;margin-top:4px">Stocks trading near or below book value</span></a>
    </div>
    <div style="margin-top:40px;padding:24px;border-radius:16px;background:#eef8f5;border:1px solid rgba(15,118,110,.15)">
      <strong style="display:block;font-size:16px;color:#0f766e;margin-bottom:8px">Screen for Undervalued Stocks Free →</strong>
