...
export async function onRequestGet({ env }) {
  ...
  const STATIC_ARTICLES = [
    {
      slug: 'high-roe-low-debt-stocks',
      title: 'High ROE, Low Debt Stocks: The Quality Combination That Matters',
      description: 'Learn why combining high return on equity with low debt reveals truly exceptional businesses — and how to screen for these quality stocks free on DeltaScreener.',
      cluster: 'Quality Investing',
      published_at: '2026-06-09',
    },
    {
      slug: 'how-to-read-a-balance-sheet-stocks',
      title: 'How to Read a Balance Sheet as a Stock Investor',
      description: 'Learn how to read a company balance sheet to evaluate financial health. Understand assets, liabilities, equity, current ratio, and D/E ratio — in plain English.',
