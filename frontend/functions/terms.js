...
export async function onRequestGet() {
  ...
  const bodyHtml = `
    <main style="max-width:760px;margin:0 auto;padding:56px 16px 80px;font-family:Inter,system-ui,sans-serif;color:#111827">
      ...
      <p style="font-size:16px;line-height:1.8;color:#374151;margin:0 0 16px">Nothing on DeltaScreener constitutes investment advice. All data and content is for informational and educational purposes only. See our <a href="/disclaimer" style="color:#0f766e;font-weight:600">Disclaimer</a> for full details.</p>
      ...
      <p style="font-size:16px;line-height:1.8;color:#374151;margin:0 0 32px">Questions: <a href="mailto:hello@deltascreener.com" style="color:#0f766e;font-weight:600">hello@deltascreener.com</a></p>
    </main>`
